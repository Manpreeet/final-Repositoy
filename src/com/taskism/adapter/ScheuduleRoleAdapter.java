 ...
 * 
 */
public class ScheuduleRoleAdapter extends BaseAdapter {

	private Context context;
	private List<RoleBean> userBeansList;

	/**
	 * 
	 */
	public ScheuduleRoleAdapter(Context context, List<RoleBean> userBeansList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		RoleBean userBean = userBeansList.get(position);
		viewHolder.deleteUser.setVisibility(View.GONE);
		viewHolder.editUser.setVisibility(View.GONE);
		viewHolder.userName.setText(userBean.roleName);
		return convertView;
	}
