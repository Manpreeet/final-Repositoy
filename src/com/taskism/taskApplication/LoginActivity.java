...
import com.taskism.request.SettingAsyncTask;
		...
		if (email.length() == 0 && password.length() == 0) {
			...
			try {
				if (isConnectedToInternet()) {
					...
					new Utility().showCustomDialog(Constant.internetConnectionPopupButtonText, Constant.internetConnectionTitle,
							Constant.internetConnectionMessage, false, LoginActivity.this,
							null, null);
				}
			} catch (Exception e) {
				e.printStackTrace();
